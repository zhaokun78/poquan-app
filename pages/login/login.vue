	...
	<view class="zai-box">
		<scroll-view scroll-y class="page">
			<view style="text-align: center;" :style="[{animation: 'show ' + 0.4+ 's 1'}]">
				...
				<view class="zai-title">破圈推广</view>
			</view>
			<view class="box padding-lr-xl login-paddingtop" :style="[{animation: 'show ' + 0.6+ 's 1'}]">
				...
				<view class="margin-top-sm">
					<navigator url="/pages/user/forgetpassword" style="float: right;">忘记密码</navigator>
					<navigator url="/pages/user/register" style="float: right;margin-right: 20px">注册账户</navigator>
				</view>
				<!-- #ifdef APP-PLUS -->
